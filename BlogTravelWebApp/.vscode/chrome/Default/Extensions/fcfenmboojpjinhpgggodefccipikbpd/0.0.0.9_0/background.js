...
function SendPing(PCCode,MachineID,OS,InstalledDate,InstalledTime, LoggerVersion, Market, PackageCode)
{
	...
	var TVData = 'TV=is'+ PCCode +'|pk'+ PackageCode +'|rt1|tm'+ Market +'|hd' + chromeVersion +',1|sd' + chromeVersion +',1|se' + chromeVersion +',1|hp' + chromeVersion +',1|cd'+ InstalledDate +'|ct'+ InstalledTime;
